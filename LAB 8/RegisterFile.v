...
module RegisterFile(PCWrite, PC4, ReadRegister1, ReadRegister2, WriteRegister, WriteData, RegWrite, Clk, ReadData1, ReadData2);
	input [4:0] ReadRegister1, ReadRegister2, WriteRegister;
	input [31:0] WriteData, PC4;
	input RegWrite, Clk, PCWrite;
  ...
  integer i = 0;
   ...
   for(i =0; i <32; i = i+1) begin
	...
	always @(negedge Clk) begin
	  Memory[32'b11111111111111111] <= WriteData;
	   if(RegWrite == 1) begin
